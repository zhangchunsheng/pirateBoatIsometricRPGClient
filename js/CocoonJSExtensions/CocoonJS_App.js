(function () {
     ...
     * @param {CocoonJS.App.StorageType} [storageType] The developer can specify the storage where it is stored. If no value is passed, the {@link CocoonJS.App.StorageType.TMP_STORAGE} value is used by default.
     * @param {CocoonJS.App.CaptureType} captureType. Optional value to choose capture type. [0: captures everything, 1: only captures cocoonjs surface, 2: only captures system views]. @see CocoonJS.App.CaptureType
     * @see CocoonJS.App.onScreenCaptureSucceeded
     * @see CocoonJS.App.onScreenCaptureFailed
     */
    CocoonJS.App.captureScreenAsync = function (fileName, storageType, captureType) {
        if (CocoonJS.App.nativeExtensionObjectAvailable) {
            window.ext.IDTK_APP.makeCall("captureScreenAsync", fileName, storageType, captureType);
        }
    };
    ...
    /**
     * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.App.onScreenCaptureSucceeded} event calls.
     * @name OnScreenCaptureSucceededListener
     * @function
     * @static
     * @memberOf CocoonJS.App
     * @param {string} url The url of the screen capture image.
     */
    /**
     * This {@link CocoonJS.EventHandler} object allows listening to events called when a screen capture operation succeeds
     * @event
     * @static
     * @memberOf CocoonJS.App
     */
    CocoonJS.App.onCaptureScreenSucceeded = new CocoonJS.EventHandler("IDTK_APP", "App", "onCaptureScreenSucceeded");

    /**
     * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.App.onScreenCaptureFailed} event calls.
     * @name OnScreenCaptureFailedListener
     * @function
     * @static
     * @memberOf CocoonJS.App
     ...
     */
    /**
     * This {@link CocoonJS.EventHandler} object allows listening to events called when a screen capture operation fails
     * The callback function's documentation is represented by {@link CocoonJS.App.OnTextDialogFinishedListener}
     * @event
     * @static
     * @memberOf CocoonJS.App
     */
    CocoonJS.App.onCaptureScreenFailed = new CocoonJS.EventHandler("IDTK_APP", "App", "onCaptureScreenFailed");
